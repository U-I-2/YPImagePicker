Pod::Spec.new do |s|
  s.name             = 'BeehomeYPImagePicker'
  s.version          = "5.2.3"
  s.summary          = "Instagram-like image picker & filters for iOS"
  s.homepage         = "https://github.com/U-I-2/YPImagePicker"
  s.license          = { :type => "MIT", :file => "LICENSE" }
  s.authors = { "Beehome" => "info@beehome.company" }
  s.platform         = :ios
  s.source           = { :git => "https://github.com/U-I-2/YPImagePicker.git",
                         :tag => s.version.to_s }
